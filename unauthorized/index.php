...
<head>
	...
	<title>Unauthorized | TCAN / VITA Lincoln | University of Nebraska&ndash;Lincoln</title>
	<!-- TemplateEndEditable -->
			...
			<div class="dcf-breadcrumbs-wrapper">
				<nav class="dcf-breadcrumbs" id="dcf-breadcrumbs" role="navigation" aria-label="breadcrumbs">
					...
					<ol>
						...
						<li><span aria-current="page">Unauthorized</span></li>
					</ol>
					<!-- TemplateEndEditable -->
				</nav>
			</div>
	...
	<div class="dcf-main-content dcf-wrapper">
		...
		<div class="dcf-bleed">
			<div class="dcf-wrapper dcf-pt-8 dcf-pb-8">
				...
				<h2 class="error-name">Unauthorized</h2>
				<div class="error-description">You are not authorized to access this page.<br>Contact your site coordinator if you feel this to be an error.</div>
			</div>
		</div>
		<!-- TemplateEndEditable -->
	</div>
