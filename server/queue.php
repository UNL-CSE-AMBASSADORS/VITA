<?php
	...
	$stmt = $conn->prepare("SELECT DISTINCT appointmentId, scheduledTime, firstName, lastName, timeIn, timeReturnedPapers, actualAppointmentTime, timeFinished, completed, notCompleted, notCompletedDescription
		FROM Appointment
