...
function getUserTable($data){
	...
	while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
		...
		$tbody.= "<td data-header='Permissions'><select class='userPermissionList userPermissionsSelectPicker' data-style='dcf-btn dcf-btn-secondary' multiple=true>".implode('', $permissionsList['options'])."</select></td>";
